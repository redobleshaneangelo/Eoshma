<template>
                    ...
                    <div v-if="activeTab === 'financial'" class="space-y-6">
                        <div class="bg-white rounded-lg border border-gray-200 shadow-sm p-6">
                            ...
                            <div class="w-full bg-gray-200 rounded-full h-2">
                                <div class="bg-gradient-to-r from-blue-700 via-sky-600 to-sky-400 h-2 rounded-full" :style="{ width: financialSummary.budgetProgress + '%' }"></div>
                            </div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="space-y-4">
                                    <div v-for="category in financialCategories" :key="category.name">
                                        ...
                                        <div class="w-full bg-gray-200 rounded-full h-2">
                                            <div class="bg-gradient-to-r from-blue-600 to-sky-500 h-2 rounded-full" :style="{ width: category.progress + '%' }"></div>
                                        </div>
    ...
    <div v-if="showProcurementRequestModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    ...
    <div v-if="showEquipmentRequestModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div class="p-6 border-b border-gray-200 sticky top-0 bg-white">
                <div class="flex items-center justify-between">
    ...
    <!-- Recruitment Modal -->
    <div v-if="showRecruitmentModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
        <div class="bg-white rounded-lg shadow-xl max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
            <div class="p-6 border-b border-gray-200 sticky top-0 bg-white">
                <div class="flex items-center justify-between">
    ...
    <!-- Add Document Modal -->
    <div v-if="showMonitoringAddDocumentModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
