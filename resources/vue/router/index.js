...
import PreBiddingWizardView from '@/views/Pages/CRM/Prebiddings/PreBiddingWizardView.vue'
...
import OperationsPendingApproval from '@/views/Pages/Operations/Pending Approvals/PendingApproval.vue'
import OperationsPendingApprovalDetail from '@/views/Pages/Operations/Pending Approvals/PendingApprovalDetail.vue' 
...
const routes = [
    ...
    */
    ...
    { path: '/prebiddings/:id', name: 'prebidding_view', component: PreBiddingWizardView, meta: { requiresAuth: true, permission: 'Prebiddings.view' } },
    ...
    */
    ...
    // Pending Approvals 
    { path: '/operations/pending-approvals/:id', name: 'operations_pending_approval_detail', component: OperationsPendingApprovalDetail, meta: { requiresAuth: true, department: 'Operations' } },
